...
const Home = () => {
  ...
  return (
    <div className='h-screen relative overflow-hidden'>
      <img className ='w-16 absolute left-5 top-5' src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Uber_logo_2018.svg/2560px-Uber_logo_2018.svg.png" alt="logo" />
      ...
      <div className='flex flex-col justify-end h-screen absolute top-0 w-full'>
        ...
        <form onSubmit={(e) =>{
          ...
          <div className='line absolute h-16 w-1 top-[48%] left-20 bg-gray-700 rounded-full'></div>

          {/* TWO ways Banding profrom */}
          <input 
          onClick={()=>{
            setPanelOpen(true)
          }}
